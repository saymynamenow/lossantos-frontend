...
const MentionTextarea = forwardRef<MentionTextareaRef, MentionTextareaProps>(
  (
    ...
    const minHeight = rows * 24; // Approximate line height of 24px

    return (
      <div className={`relative ${className}`}>
        <div
          className="w-full px-4 py-3 border border-gray-300 rounded-lg bg-white text-black focus-within:ring-2 focus-within:ring-blue-500 focus-within:border-blue-500 transition-all duration-200 hover:border-gray-400"
          style={{ minHeight: `${minHeight + 24}px` }} // Add padding to minHeight
        >
          <Editor
            ref={editorRef}
